 ...
 */
//pdf
Route::get('pdf',[PostController::class,'download_pdf'])->name('download.pdf');
//
...
Route::get('homepage/post', [HomepageController::class, 'post_tag'])->name('homepage.post_tag');
Route::get('homepage/post/detail', [HomepageController::class, 'post_detail'])->name('homepage.post_detail');
Route::get('homepage/contract', [HomepageController::class, 'contract'])->name('homepage.contract');
...
Route::get('edit/post',[EditController::class,'post'])->name('edit.post');
...
Route::get('post/edit/{UNID}',[PostController::class,'post_edit'])->name('post.show.edit');
